package musicplayersql;
import musicplayersql.Classes.Substanses.Song;
import java.sql.*;
import java.util.ArrayList;
import java.util.List;
import musicplayersql.Classes.Generator.Generator;
...
import musicplayersql.Classes.View.View;
...
public class MusicPlayerSQL {
    ...
    private static final String DB_LOGIN = "stud";
    private static final String DB_PASSWORD = "stud";
    private static final String DB_URL = "jdbc:derby://localhost:1527/MusicPlayerData";
